...
const CreatePostModal = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-trippiko-card p-8 rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <button 
            ...
            className="text-trippiko-light hover:text-trippiko-accent text-2xl"
          >
            ×
          </button>
        </div>
